...
data manually. The obtained dataset has been randomly partitioned 
...
body acceleration and gravity. The gravitational force is assumed 
to have only low frequency components, therefore a filter with 0.3 Hz 
